...
DIFF_KEY_HELP = "Identifies all missing keys from the non-base project in the specified languages."
PROJECT_DIR_HELP = "The Xcode project directory. Defaults to the current directory."
...
def build_parser():
    ...
    parser.add_argument("-l", "--languages", type=str, default="Base", help=LANGUAGES_HELP)
    parser.add_argument("-d", "--project-dir", type=str, default=".", help=PROJECT_DIR_HELP)
